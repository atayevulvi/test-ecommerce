...
const WomenProduct = ({ item }) => {
  ...
  return (
    <div className='flex flex-col p-3 bg-black flex-1 border-4 items-center justify-center min-w-[300px] min-h-[250px] overflow-hidden rounded-md  m-2 relative' onMouseEnter={HandlHoverEnter} onMouseLeave={HandlHoverExit}>
